...
export function clientFromRow(row) {
  return {
    ...
    additionalSteps: row.additional_steps || [],
    additionalStepsBaseline: row.additional_steps_baseline || [],
...
export function clientToRow(client, userId) {
  return {
    ...
    additional_steps: client.additionalSteps || [],
    additional_steps_baseline: client.additionalStepsBaseline || [],
